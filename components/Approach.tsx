    ...
    return (
        ...
        >
            ...
            <div className="relative z-20">
                ...
                group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold
                ...
                z-10 mt-4  font-bold group-hover/canvas-card:text-white
                 group-hover/canvas-card:-translate-y-2 transition duration-200 text-[#e4ecff] text-center">
                    {desc}
                </h2>
            </div>
        </div>
